...
import MetaSerifWOFF from "#/fonts/MetaSerif/meta-normal-webfont.woff";
import MetaSerifWOFF2 from "#/fonts/MetaSerif/meta-normal-webfont.woff2";

import FiraCodeLightWOFF from "#/fonts/FiraCode/FiraCode-Light.woff";
import FiraCodeLightWOFF2 from "#/fonts/FiraCode/FiraCode-Light.woff2";
import FiraCodeLightTTF from "#/fonts/FiraCode/FiraCode-Light.ttf";

import FiraCodeBoldWOFF from "#/fonts/FiraCode/FiraCode-Bold.woff";
import FiraCodeBoldWOFF2 from "#/fonts/FiraCode/FiraCode-Bold.woff2";
import FiraCodeBoldTTF from "#/fonts/FiraCode/FiraCode-Bold.ttf";
...
import FiraCodeRegularTTF from "#/fonts/FiraCode/FiraCode-Regular.ttf";
...
import FiraCodeMediumTTF from "#/fonts/FiraCode/FiraCode-Medium.ttf";

const FontFaces = css`
  @font-face {
    font-family: "ff-meta-serif-web-pro";
    src: url(${MetaSerifWOFF2}) format("woff2"), url(${MetaSerifWOFF}) format("woff");
  }

  @font-face {
    font-family: "Fira Code";
    src: url(${FiraCodeLightWOFF2}) format("woff2"), url(${FiraCodeLightWOFF}) format("woff"),
      url(${FiraCodeLightTTF}) format("truetype");
    font-weight: 300;
    font-style: normal;
  }
  ...
  @font-face {
    font-family: "Fira Code";
    src: url(${FiraCodeBoldWOFF2}) format("woff2"), url(${FiraCodeBoldWOFF}) format("woff"),
      url(${FiraCodeBoldTTF}) format("truetype");
    font-weight: 900;
    font-style: normal;
  }
  ...
  @font-face {
    font-family: "Fira Code";
    src: url(${FiraCodeRegularWOFF2}) format("woff2"), url(${FiraCodeRegularWOFF}) format("woff"),
      url(${FiraCodeRegularTTF}) format("truetype");
    font-weight: normal;
    font-style: normal;
  }
  ...
  @font-face {
    font-family: "Fira Code";
    src: url(${FiraCodeMediumWOFF2}) format("woff2"), url(${FiraCodeMediumWOFF}) format("woff"),
      url(${FiraCodeMediumTTF}) format("truetype");
    font-weight: 500;
    font-style: normal;
  }
